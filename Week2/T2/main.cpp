...
class LNode
{
    ...
    public:
        ...
        LNode(char s):m_char_Element(s),m_Next(NULL),m_Previous(NULL){}
        //destruction
        ~LNode(){}
        ...
        void m_OutPut(char c)
        {
            std::cout << m_char_Element <<" ";
        }
...
void LNodeList::m_OutPut(char c)
{
    if(m_Head == m_Tail)
    {
        cout << "\n";
